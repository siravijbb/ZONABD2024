...
<div class="mx-auto grid w-full max-w-4xl grid-cols-1 space-y-2 rounded-lg bg-gray-200 shadow-lg">
	<div class="mx-auto h-fit w-full rounded-lg bg-white pb-9 shadow-lg md:mt-2">
		<div class="">
			<h1 class="mx-auto py-2 text-center text-4xl font-semibold text-aisha">
					...
					<div class="mx-auto mt-2 h-20 w-20 md:h-40 md:w-40 rounded-lg bg-aisha shadow-lg grid grid-cols-1">
						<div class="static mx-auto  my-auto ">
							<svg xmlns="http://www.w3.org/2000/svg" class="w-[75%] mx-auto" viewBox="0 0 36 36">
								<path fill="white" d="M5.6 4A1.6 1.6 0 0 0 4 5.6V12h8V4Zm4.4 6H6V6h4Z" class="clr-i-outline clr-i-outline-path-1" />
								<path fill="white" d="M4 30.4A1.6 1.6 0 0 0 5.6 32H12v-8H4ZM6 26h4v4H6Z" class="clr-i-outline clr-i-outline-path-2" />
								<path fill="white" d="M24 32h6.4a1.6 1.6 0 0 0 1.6-1.6V24h-8Zm2-6h4v4h-4Z" class="clr-i-outline clr-i-outline-path-3" />
								<path fill="white" d="M30.4 4H24v8h8V5.6A1.6 1.6 0 0 0 30.4 4m-.4 6h-4V6h4Z" class="clr-i-outline clr-i-outline-path-4" />
								...
								<path fill="white" d="M20 6v2h2V4h-8v4h2V6z" class="clr-i-outline clr-i-outline-path-8" />
								<path fill="white" d="M4 14h2v4H4z" class="clr-i-outline clr-i-outline-path-9" />
								<path fill="white" d="M12 16v2h-2v-4H8v4H6v2H4v2h4v-2h2v2h2v-2h2v-4z" class="clr-i-outline clr-i-outline-path-10" />
								<path fill="white" d="M20 16h2v2h2v-2h2v-2h-4v-4h-2v2h-2v2h2z" class="clr-i-outline clr-i-outline-path-11" />
								<path fill="white" d="M18 30h-4v2h8v-2h-2v-2h-2z" class="clr-i-outline clr-i-outline-path-12" />
								<path fill="white" d="M22 20v-2h-2v-2h-2v2h-2v2h2v2h2v-2z" class="clr-i-outline clr-i-outline-path-13" />
								...
								<path fill="white" d="M30 14h-2v2h-2v2h2v2h2v-2h2v-2h-2z" class="clr-i-outline clr-i-outline-path-16" />
								<path fill="white" d="M20 22h2v6h-2z" class="clr-i-outline clr-i-outline-path-17" />
								<path fill="white" d="M14 28h2v-2h2v-2h-2v-4h-2z" class="clr-i-outline clr-i-outline-path-18" />
					...
					<div class="mx-auto mt-2 h-20 w-20 md:h-40 md:w-40 rounded-lg bg-aisha shadow-lg grid grid-cols-1">
						<div class="static mx-auto  my-auto ">
							<svg xmlns="http://www.w3.org/2000/svg" class="w-[75%] mx-auto" viewBox="0 0 24 24">
								<path fill="white" d="M4 22q-.425 0-.712-.288T3 21v-5q0-.825.588-1.412T5 14v-4q0-.825.588-1.412T7 8h4V6.55q-.45-.3-.725-.725T10 4.8q0-.375.15-.738t.45-.662L12 2l1.4 1.4q.3.3.45.662T14 4.8q0 .6-.275 1.025T13 6.55V8h4q.825 0 1.413.587T19 10v4q.825 0 1.413.588T21 16v5q0 .425-.288.713T20 22zm3-8h10v-4H7zm-2 6h14v-4H5zm2-6h10zm-2 6h14zm14-6H5z" />
							</svg>
						</div>
						<p class="-mt-2 md:-mt-4 text-center text-white text-xs md:text-lg">ส่งคำอวยพร</p>
					</div>
				</a>
