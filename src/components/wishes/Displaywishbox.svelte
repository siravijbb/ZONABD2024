...
<div id="countLimit">
    ...
    >
        {#each Wishdata.wish as wish (wish.count)}
            {#if wish.picture == 1}
                <div
                        class="relative flex h-full min-h-48 w-full max-w-[349.333px] justify-self-center overflow-hidden rounded-none bg-aisha p-2 text-black/50 shadow-md md:min-h-72 snap-start"
                        data-aos="fade-in"
                        id="one"
                >
