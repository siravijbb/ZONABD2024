...
<ul class="grid w-full grid-cols-3 gap-2 md:grid-cols-3">
	<li>
		...
		>
			<div class="mx-auto">
				<img alt="Hoku " src="/Wish/Guppiens/1.png" class="-my-7 mx-auto -mt-9 flex h-auto w-28" />
			</div>
		</label>
	</li>
	<li>
		...
		>
			<div class="mx-auto">
				<img alt="Idol " src="/Wish/Guppiens/2.png" class="-my-7 mx-auto -mt-9 flex h-auto w-28" />
			</div>
		</label>
	</li>
	<li>
		...
		>
			<div class="mx-auto">
				<img alt="Winter Wonder " src="/Wish/Guppiens/3.png" class="-my-7 mx-auto -mt-9 flex h-auto w-28" />
			</div>
		</label>
	</li>
	<li>
		...
		>
			<div class="mx-auto">
				<img alt="3 Year Anni " src="/Wish/Guppiens/4.png" class="-my-8 mx-auto -mt-8 flex h-auto w-28" />
			</div>
		</label>
	</li>
	<li>
		...
		>
			<div class="mx-auto">
				<img alt="3 Year Anni " src="/Wish/Guppiens/5.png" class="-my-8 mx-auto -mt-8 flex h-auto w-28" />
			</div>
		</label>
	</li>
	<li>
		...
		>
			<div class="mx-auto">
				<img alt="3 Year Anni " src="/Wish/Guppiens/6.png" class="-my-8 mx-auto -mt-8 flex h-auto w-28" />
			</div>
		</label>
	</li>
</ul>
