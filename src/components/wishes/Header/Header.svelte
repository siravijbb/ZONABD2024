...
<div class="">
	<h1 class="mx-auto pt-2 text-center text-3xl font-semibold text-aisha HEADER">AISHA BIRTHDAY WISHES</h1>
	<h1 class="mx-auto -mt-1 pb-2 text-center text-2xl HEADER">ร่วมเขียนคำอวยพรให้ไอช่า</h1>
</div>
<style>
