	...
	<div class="">
		...
		<div class=" mx-auto block text-center">
			...
			<div class="-mt-1">
				...
				<p class=" md:text-md text-red-600">โอนเงินแล้วอย่าลืมแจ้งหลักฐานโอนเงิน<a class="text-aisha" href="https://docs.google.com/forms/d/1CrC41ZuzznBBvkCIfvMwSyyykJx0bJMuGqR85UlXLkM/viewform?edit_requested=true">ที่นี้!</a></p>
			</div>
		</div>
	</div>
</div>
